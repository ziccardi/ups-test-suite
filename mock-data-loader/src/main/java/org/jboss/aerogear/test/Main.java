...
public class Main implements ICliUtils {
    ...
    public static void main(String[] args) {
        ...
        options.addOption(Option.builder("p").longOpt(OPTION_PASSWORD).hasArg(true).argName("password").desc("Password to be used to authenticate to the UPS").required(true).build());
